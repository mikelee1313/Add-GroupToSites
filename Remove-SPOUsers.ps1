<#
.SYNOPSIS
    Removes a specified Microsoft 365 group as a site collection administrator from all SharePoint Online sites in the tenant.

.DESCRIPTION
    This script connects to the SharePoint Admin center and iterates through all SharePoint Online sites 
...
.OUTPUTS
    Log file at $env:TEMP\Removing_Group_from_SPO_Sites_[timestamp].txt with information about the operations performed.
#>
...
$logFilePath = "$env:TEMP\Removing_Group_from_SPO_Sites_$startime.txt"
